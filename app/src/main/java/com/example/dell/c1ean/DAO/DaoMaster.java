...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        UserWalletDao.createTable(db, ifNotExists);
        CompanyInaccountDao.createTable(db, ifNotExists);
        WokerInaccountDao.createTable(db, ifNotExists);
        UserAttendDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        UserWalletDao.dropTable(db, ifExists);
        CompanyInaccountDao.dropTable(db, ifExists);
        WokerInaccountDao.dropTable(db, ifExists);
        UserAttendDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(UserWalletDao.class);
        registerDaoClass(CompanyInaccountDao.class);
        registerDaoClass(WokerInaccountDao.class);
        registerDaoClass(UserAttendDao.class);
    }
